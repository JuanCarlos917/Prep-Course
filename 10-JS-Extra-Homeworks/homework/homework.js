...
function asAmirror(str) {
  ...
  //Escribe tu código aquí
    ...
    string.forEach(palabra => { mirror.push(palabra.split('').reverse().join(''))})
    return (mirror.join(' '))
}
...
function deleteAbc(cadena){
  ...
  //Escribe tu código aquí
    let letters = cadena.replaceAll('a','').replaceAll('b','').replaceAll('c','')
    return letters;
}
...
function buscoInterseccion(arreglo1, arreglo2){
  ...
  //Escribe tu código aquí
    ...
    arreglo1.forEach(a1 =>{arreglo2.forEach(a2 =>{
